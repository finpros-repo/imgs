...
Checking overfit...
     Pass check overfit
```
Chỉ cần 1 trong 2 bài test không pass, bạn cần kiểm tra, sửa lại logic alpha và thực hiện [backtest](#backtest), [test](#test-alpha-trước-submit) lại.
